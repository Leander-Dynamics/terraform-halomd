...
{
    [Index(nameof(IsDeleted),nameof(PayorClaimNumber))]
    [Index(nameof(IsDeleted),nameof(Authority),nameof(AuthorityStatus))]
    [Index(nameof(IsDeleted),nameof(Payor), nameof(PayorClaimNumber))]
    [Index(nameof(IsDeleted),nameof(Customer),nameof(PatientName), nameof(ProviderNPI), nameof(ServiceDate))]
    [Index(nameof(IsDeleted),nameof(EHRNumber),nameof(Authority))]
    [Index(nameof(IsDeleted),nameof(AuthorityCaseId),nameof(Authority),nameof(Id),IsUnique=true)]
    public class ArbitrationCase 
    {
        ...
        [StringLength(10)]
        public string LocationGeoZip { get; set; } = ""; /** MPower field - full zipcode of service location */
        ...
        [StringLength(1024)]
        public string NSATracking { get; set; } = ""; /** The last saved version of any NSA date tracking info */
        ...
        */
        ...
        //public string ServiceZip { get; set; } = "";  /** MPower field - full zipcode of service location */
